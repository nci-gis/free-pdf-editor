<script>
  ...
  const STORAGE_KEY = 'textReplace_noticeSeen';
  ...
  >
    ...
    >
      ...
      <div class="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-4">
        <h2 id="notice-title" class="text-xl font-semibold text-white flex items-center gap-2">
      ...
      <div class="px-6 py-5 space-y-4">
        ...
        <div class="flex items-start gap-3">
          ...
          <p class="text-gray-700 text-sm leading-relaxed">
            Try different fonts from the dropdown, or import your own fonts to get a closer match.
          </p>
        </div>
      </div>
