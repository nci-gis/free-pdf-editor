      ...
      <div class="flex-1 overflow-y-auto px-6 py-5 space-y-6">
        ...
        <section>
          ...
          <ul class="space-y-2 text-sm text-gray-600 ml-8">
            ...
            <li>
              Hold <kbd class="px-1 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Shift</kbd> while
        ...
        <section>
          ...
          <ul class="space-y-2 text-sm text-gray-600 ml-8">
            <li>
              Press <kbd class="px-1 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">E</kbd> or click
              "Replace Text" in the sidebar to enter edit mode.
            </li>
            ...
            <li>
              Click outside or press <kbd
                class="px-1 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Escape</kbd
              > to finish editing.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <div class="ml-8 mt-3 p-3 bg-purple-50 border border-purple-200 rounded-md text-sm text-gray-600">
            ...
            <p>
              To find the exact fonts used in a PDF, open it in Adobe Acrobat and go to
              <strong>Menu &gt; Document Properties &gt; Fonts</strong> (Windows) or
              <strong>File &gt; Document Properties &gt; Fonts</strong> (macOS).<br />
              The Fonts tab lists all typefaces used in the document. Pay attention to exact spelling, capitalization, and
              hyphens &mdash; then select or import the matching font here for best results.
            </p>
            <a
              ...
              <tbody class="divide-y divide-gray-100">
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Ctrl+S</kbd
                    ></td
                  >
                ...
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">E</kbd></td
                  >
                  <td class="py-1.5 text-gray-600">Toggle Replace Text mode</td>
                </tr>
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">D</kbd></td
                  >
                  <td class="py-1.5 text-gray-600">Toggle debug overlay (edit mode)</td>
                </tr>
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">F1</kbd
                    ></td
                  >
                ...
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono">Escape</kbd
                    ></td
                  >
                ...
                <tr>
                  <td class="py-1.5 pr-4"
                    ><kbd class="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs font-mono"
                      >Ctrl+Shift+R</kbd
                    ></td
                  >
