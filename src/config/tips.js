export const tips = [
  {
    icon: `<path fill="none" stroke="#BF2425" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>`,
    title: 'Hard Refresh',
    description: 'Static files may be cached. Press Ctrl+Shift+R to force reload latest version',
  },
  {
    ...
    title: 'Open PDF',
    description: "Click 'Open PDF' button or drag & drop a file anywhere",
  },
  {
    icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>`,
    title: 'Add Image',
    description: 'Click the image icon in the toolbar to insert images',
  },
  {
    icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>`,
    title: 'Add Text',
    description: 'Click the text icon to add editable text fields',
  },
  {
  ...
  // },
  {
    ...
    title: 'Save PDF',
    description: "Click 'Save' or press Ctrl+S to download the edited PDF",
  },
];

export const TIPS_STORAGE_KEY = 'pdf-editor-tips-position';

export const DEFAULT_POSITION = {
  x: null, // null means use default (bottom-right)
  y: null,
};
